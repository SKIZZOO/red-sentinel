...
from .chat import patch_chat_api
...
async def _start_web_fixed(self):
    ...
    app.add_routes([
        ...
        web.get("/api/guilds/{guild_id}/channels/{channel_id}/messages",self.api_channel_messages),web.post("/api/guilds/{guild_id}/channels/{channel_id}/messages",self.api_send_chat_message),web.delete("/api/guilds/{guild_id}/channels/{channel_id}/messages/{message_id}",self.api_delete_chat_message),web.get("/api/guilds/{guild_id}/members/{user_id}/profile",self.api_chat_profile),
