(()=>{
  ...
  css('chat-css','./chat.css?v=20260911-7');load('chat-js','script','./chat.js?v=20260911-7');load('chat-nav-dedupe-js','./chat-nav-dedupe.js?v=20260911-1');
  ...
  css('server-true-bleed-css','./server-true-bleed.css?v=20260911-1');
