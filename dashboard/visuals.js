(()=>{
  ...
  css('server-modern-css','./server-modern.css?v=20260911-1');
  css('server-polish-css','./server-polish.css?v=20260911-5');load('server-fix-js','script','./server-fix.js?v=20260911-1');load('platform-icons-js','script','./platform-icons.js?v=20260911-1');
})();
