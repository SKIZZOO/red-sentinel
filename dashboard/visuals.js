(()=>{
  ...
  css('streams-platforms-css','./streams-platforms.css?v=20260911-3');
  css('streams-ui-enhancements-css','./streams-ui-enhancements.css?v=20260911-2');
  ...
  load('streams-ui-enhancements-js','script','./streams-ui-enhancements.js?v=20260911-2');
  load('server-fix-js','script','./server-fix.js?v=20260911-1');load('platform-icons-js','script','./platform-icons.js?v=20260911-1');
  // Re-run the latest static streams module after the page's legacy script has loaded.
  setTimeout(()=>{const s=document.createElement('script');s.src='./streams.js?v=20260911-3';s.dataset.streamsLatest='1';document.body.appendChild(s)},1200);
})();
